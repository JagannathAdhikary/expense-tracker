// Inline SVG icons (currentColor stroke) used across the header, menu, and sheets.
// Kept as functions returning markup so they can be dropped into innerHTML/templates.
...
export const icon = {
  ...
  // Debt simplification: 3 people as dots in a triangle. The two legs through the apex
  // are DASHED (the roundabout/unnecessary transactions); the base is a SOLID line (the
  // one simplified transaction that replaces them).
  simplify: (o) =>
    svg('<path d="M6 17.5 12 6" stroke-dasharray="2 2"/><path d="M12 6 18 17.5" stroke-dasharray="2 2"/><path d="M6 17.5H18"/><circle cx="12" cy="6" r="1.8" fill="currentColor" stroke="none"/><circle cx="6" cy="17.5" r="1.8" fill="currentColor" stroke="none"/><circle cx="18" cy="17.5" r="1.8" fill="currentColor" stroke="none"/>', o),
  ...
  card: (o) => svg('<rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/>', o),
  ...
  edit: (o) => svg('<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>', o),
  ...
  copy: (o) => svg('<rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>', o),
